...
const DialogEditCV: React.FC<DialogEditCVProps> = ({ onFileChange }) => {
  ...
  return (
    <div className="flex items-center justify-center gap-x-5">
      <CustomOutlineDiv className="w-full">
        <Button className="inline-flex items-center justify-center rounded-xl bg-gray-900 px-4 py-1.5 font-medium text-gray-50 transition-colors duration-200 hover:bg-gray-700 active:bg-gray-800 w-full">
          Download CV
        </Button>
      </CustomOutlineDiv>
