  ...
  return (
    <div className="flex max-w-xl flex-col gap-6">
      ...
      <Typography>
        ...
        building cutting-edge web applications using modern technologies such as
      ...
      <Typography>
        ...
        where I share tech-related bites and build in public, or you can follow
        me on{" "}
        <Link
          noCustomization
          externalLink
      ...
      <div className="flex flex-col gap-2 md:flex-row md:gap-6">
        <ul className="flex list-inside list-disc flex-col gap-2">
          <Typography component="li">B.E. in Computer Engineering</Typography>
