...
import { NAV_LINKS_LAWYER } from "@/lib/data";
...
import logo_default from "@/../public/portfolio-lawyer/header/logo_default.svg";
import logo_default_dark from "@/../public/portfolio-lawyer/header/logo_default_dark.svg";
      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between p-4 md:px-8">
        ...
        <div className="hidden items-center gap-6 md:flex">
          <ul className="flex list-none items-center gap-6">
            {NAV_LINKS_LAWYER.map((link, index) => (
              <li key={index}>
                <Link
                  href={link.href}
                  onClick={(e) => {
